...
extern "C" {
    ...
    pub fn LLVMRustValueGetName(V: &Value) -> *const c_char;
    ...
    pub fn LLVMGetParam<'a>(Fn: &Value, Index: c_uint) -> &'a Value;
    ...
    pub fn LLVMGetInsertBlock<'a>(Builder: &Builder<'a>) -> Option<&'a BasicBlock>;
    ...
    //         Src: &'a Value,
    //     ) -> Option<&'a Value>;
    //     pub fn LLVMRustBuildVectorReduceAdd(B: &Builder<'a>, Src: &'a Value) -> Option<&'a Value>;
    //     pub fn LLVMRustBuildVectorReduceMul(B: &Builder<'a>, Src: &'a Value) -> Option<&'a Value>;
    //     pub fn LLVMRustBuildVectorReduceAnd(B: &Builder<'a>, Src: &'a Value) -> Option<&'a Value>;
    //     pub fn LLVMRustBuildVectorReduceOr(B: &Builder<'a>, Src: &'a Value) -> Option<&'a Value>;
    //     pub fn LLVMRustBuildVectorReduceXor(B: &Builder<'a>, Src: &'a Value) -> Option<&'a Value>;
    ...
    //         IsSigned: bool,
    //     ) -> Option<&'a Value>;
    //     pub fn LLVMRustBuildVectorReduceFMin(
    //         B: &Builder<'a>,
    //         Src: &'a Value,
    //         IsNaN: bool,
    //     ) -> Option<&'a Value>;
    //     pub fn LLVMRustBuildVectorReduceFMax(
    //         B: &Builder<'a>,
    //         Src: &'a Value,
    //         IsNaN: bool,
    //     ) -> Option<&'a Value>;
    ...
    pub fn LLVMRustConstantAsMetadata<'a>(C: &'a Value) -> &'a Metadata;
...
extern "C" {
    pub fn LLVMInitializeNativeTarget();
    pub fn InitializeNativeTargetAsmPrinter();
    pub fn InitializeNativeTargetAsmParser();
    pub fn InitializeNativeTargetDisassembler();
